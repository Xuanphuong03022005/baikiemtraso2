            ...
            <form action="{{ route('order') }}" method="post" class="beta-form-checkout">
                ...
                <div class="row">
                    @if(Session::has('success'))
                       <p class="text-center text-danger"> {{ Session::get('success')}}</p>
                    @endif
                </div>
				@if(Session::has('cart'))
				<div class="row">
                            ...
                            <div class="your-order-body" style="padding: 0px 10px">
                                <div class="your-order-item">
                                    <div>
                                        ...
                                        <!-- one item -->
                                    <div class="media">
                                        <img width="25%" src="{{ asset('assets/dest/images/products/'.$product['item']['image']) }}" alt="" class="pull-left">
                                ...
                                <div class="your-order-item">
                                    ...
                                    <div class="pull-right"><h5 class="color-black">{{ number_format($products->totalPrice) }}</h5></div>
                                    <div class="clearfix"></div>
                                </div>
                            </div>
