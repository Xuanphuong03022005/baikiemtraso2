...
<head>
	...
	<link rel="stylesheet" href="{{ URL::asset('css/style_search.css') }}">
	<link rel="stylesheet" href="{{ URL::asset('assets/dest/css/huong-style.css') }}">
	<link rel="stylesheet" href="{{ URL::asset('assets/dest/css/style.css') }}">
