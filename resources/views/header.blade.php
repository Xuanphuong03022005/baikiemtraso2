        ...
        <div class="container">
            ...
            <div class="pull-right auto-width-right">
                <ul class="top-details menu-beta l-inline">
                    ...
                    <li><a href="{{ route('create') }}">Đăng kí</a></li>
            ...
            <div class="pull-right beta-components space-left ov">
                ...
                <div class="beta-comp">
                    <form role="search" method="get" id="searchform" action="{{ route('search') }}">
                        <input type="text" value="" name="value" id="s" placeholder="Nhập từ khóa..." />
                ...
                <div class="beta-comp">
                    <div class="cart">
                        <div class="beta-select"><a onclick="window.location.href='{{ route('cart') }}'"><i class="fa fa-shopping-cart"></a></i>
                            ...
                            <i class="fa fa-chevron-down"></i></div> <i class="fa fa-chevron-down"></i>
                    </div>
                    @if(Session::has('cart'))
                    <div class="beta-dropdown cart-body">
                        @php $data = Session::get('cart') @endphp
                        @foreach($data->items as $key => $value)
                        <div class="cart-item">
                            <div class="media">
                                <a class="pull-left"><img src="{{ asset('assets/dest/images/products/'.$value['item']['image']) }}" alt=""></a>
                                <div class="media-body">
                                    <span class="cart-item-title">{{ $value['item']['name'] }}</span>
                                    <span class="cart-item-options">{{ $value['item']['unit'] }}</span>
